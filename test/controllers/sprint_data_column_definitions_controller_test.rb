...
class SprintDataColumnDefinitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint_data_column_definition" do
    assert_difference("SprintDataColumnDefinition.count") do
      post sprint_data_column_definitions_url, params: { sprint_data_column_definition: { name: @sprint_data_column_definition.name, position: @sprint_data_column_definition.position } }
    end
  ...
  test "should update sprint_data_column_definition" do
    patch sprint_data_column_definition_url(@sprint_data_column_definition), params: { sprint_data_column_definition: { name: @sprint_data_column_definition.name, position: @sprint_data_column_definition.position } }
