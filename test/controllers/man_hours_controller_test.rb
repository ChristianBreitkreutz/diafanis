...
class ManHoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create man_hour' do
    assert_difference('ManHour.count') do
      post man_hours_url,
           params: { man_hour: { date: @man_hour.date, max: @man_hour.max, planned_absences: @man_hour.planned_absences,
                                 unplanned_absences: @man_hour.unplanned_absences } }
    end
